...
| F2 | **Caducidades completo** — baja automática de vencidos, descuento por proximidad a vencimiento, reporte de merma | ⬜ Pendiente |
| F3 | **Programa de puntos / lealtad** — puntos por compra canjeables como descuento | ⬜ Pendiente |
